...
const { PresenceHandler } = require('@deepstream/client/dist/presence/presence-handler');
...
ws.onmessage = async event => {
  ...
  if (res.block_num !== '0') {
    ...
    //console.log(datacl.deviceId);
    //console.log(datacl.temperature);
    //console.log(datacl.timestamp)
